        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            ...
            <br>
					...
					<div>
						<input class="submit_btn" type="button" value="Obriši događaj" onclick="location.href='<?php echo base_url() ?>/DogadjajAdminModeratorController/obrisi_dogadjaj/<?php echo $iddogadjaja ?>'">
					</div>
					<br><br>
				</div>
            </div>
